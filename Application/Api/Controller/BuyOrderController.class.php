...
class BuyOrderController extends Controller { //UserFilterController
    ...
    public function buy_order(){
        ...
        $base_price         = I('post.base_price', 0.00);
        $refer_price        = I('post.refer_price', 0.00); // 用户估价
        $tip_price          = I('post.tip_price', 0.00); // 感谢费
        ...
        $order_data['total_price']  = $base_price + $tip_price + $specified_price;
        ...
        $order_detail_data['address'] = $address;
